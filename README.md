...
| [**Documentation**][docs-latest-url]    | [<img src="https://img.shields.io/badge/docs-latest-blue.svg" alt = "doc badge" height="30">][docs-latest-url] [<img src="https://github.com/tmp398243/tmp3117499/actions/workflows/docs.yaml/badge.svg?branch=main" alt = "doc badge" height="30">][docs-build-url] |
|----------------------|--------------------------------------------------|
| [**CI tests**][ci-tests-url]        | [<img src="https://github.com/tmp398243/tmp3117499/actions/workflows/ci-tests.yaml/badge.svg?branch=main" alt = "CI badge" height="30">][ci-tests-url] |
...
[ci-tests-url]: https://github.com/tmp398243/tmp3117499/actions/workflows/ci-tests.yaml?query=branch%3Amain
